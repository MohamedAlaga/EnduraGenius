        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanCreatedBy = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MainMuscleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SecondaryMuscleId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Link = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WorkoutCreatedBy = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.WorkoutCreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Workouts_muscles_MainMuscleId",
                        column: x => x.MainMuscleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlanOrder = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlansUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlansUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlansUsers_Plans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastWeight = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "de6594c7-64c1-4d22-bdfc-4de7eda3628c", "de6594c7-64c1-4d22-bdfc-4de7eda3628c", "user", "USER" },
                    { "f02a0229-1fa7-4c12-8985-2436ff1b495b", "f02a0229-1fa7-4c12-8985-2436ff1b495b", "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Plans_PlanCreatedBy",
                table: "Plans",
                column: "PlanCreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_PlansUsers_PlanId",
                table: "PlansUsers",
                column: "PlanId");

            migrationBuilder.CreateIndex(
                name: "IX_PlansUsers_UserId",
                table: "PlansUsers",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workouts_MainMuscleId",
                table: "Workouts",
                column: "MainMuscleId");

            migrationBuilder.CreateIndex(
                name: "IX_Workouts_SecondaryMuscleId",
                table: "Workouts",
                column: "SecondaryMuscleId");

            migrationBuilder.CreateIndex(
                name: "IX_Workouts_WorkoutCreatedBy",
                table: "Workouts",
