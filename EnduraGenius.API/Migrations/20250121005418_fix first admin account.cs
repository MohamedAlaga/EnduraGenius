...
{
    /// <inheritdoc />
    public partial class fixfirstadminaccount : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "48149538-3d20-4314-9f75-33a92d9c2b24", 0, 22, "f02a0229-1fa7-4c12-8985-2436ff1b495b", "admin@EnduraGenius.com", false, true, true, null, "ADMIN@ENDURAGENIUS.COM", "ALAGA_ADMIN", "AQAAAAIAAYagAAAAEB8mSwn38vSJ7/KNpsmlbKq6WJrDHdhP0KFAIf+XSJ4OxMtfq7eqdLrv3IxTrqbSQg==", null, false, 0, null, "FJAS5D5VKCP3AVUILWGTTBJWK2TLWS36", 182, false, "Alaga_Admin", 95f, true });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "de6594c7-64c1-4d22-bdfc-4de7eda3628c", "48149538-3d20-4314-9f75-33a92d9c2b24" },
                    { "f02a0229-1fa7-4c12-8985-2436ff1b495b", "48149538-3d20-4314-9f75-33a92d9c2b24" }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "AspNetUserRoles",
                keyColumns: new[] { "RoleId", "UserId" },
                keyValues: new object[] { "de6594c7-64c1-4d22-bdfc-4de7eda3628c", "48149538-3d20-4314-9f75-33a92d9c2b24" });

            migrationBuilder.DeleteData(
                table: "AspNetUserRoles",
                keyColumns: new[] { "RoleId", "UserId" },
                keyValues: new object[] { "f02a0229-1fa7-4c12-8985-2436ff1b495b", "48149538-3d20-4314-9f75-33a92d9c2b24" });

            migrationBuilder.DeleteData(
                table: "AspNetUsers",
                keyColumn: "Id",
                keyValue: "48149538-3d20-4314-9f75-33a92d9c2b24");
